  ...
  const template = `
    ...
    <section class='main-section'>
      ...
      <section class='dev'>
        ...
        <p class='text-dev'>Me chamo Polyana Feitoza, tenho 21 anos e sou do Paraná. <br> Sempre foi apaixonada por doces <br> e o meu favorito é donnuts.</p> 
      ...
      <section class='dev'>
        ...
        <p class='text-dev'>Me chamo Adriana Oliveira, tenho 26 anos e sou de Fortaleza. <br> Nãe consigo esperar até a festa junina para comer meu doce favorito que é o bolo de macaxeira.</p>
