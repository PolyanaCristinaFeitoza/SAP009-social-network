  ...
  const template = `
    ...
    <section class='main-section'>
      <section class='img-txt'>
        <img src='/image/cupcake.jpg' alt='feed da rede social friandy' class='img-test'>
      ...
      <img src='/image/sobremesa.jpg' alt='feed da rede social friandy' class='img-test'>      
    </section>
    <section class='txt-img img-txt'>
      <p class='p-about'>Ver receitas e curtir os posts</p>
      <img src='/image/torta.jpg' alt='feed da rede social friandy' class='img-test'>      
    </section>
  `;
